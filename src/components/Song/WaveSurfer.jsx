...
const WaveSurferPlayer = (props) => {
  ...
  useEffect(() => {
    ...
    leftHandle.innerHTML = `<div class="handle" part="handle">
  ...
  return (
    <section className="">
      <div
        ...
        style={{ margin: "1rem 0px", minHeight: "100px" }}
      >
        <div
          className="rounded-2"
          style={{
            backgroundColor: "#BA53DE",
            height: "60%",
            width: "100%",
            position: "absolute",
            top: "50%",
      ...
      <div className="wavesurfer-controls d-flex justify-content-end aling-items-center">
        <PlayButton
          ...
          class="ratio ratio-1x1 border rounded-circle d-flex justify-content-center align-items-center"
        ></PlayButton>
      </div>
    </section>
  );
